...
class _ChatWebServices implements ChatWebServices {
  ...
  @override
  Future<List<MessagesModel>> getMessages({required int id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'id': id};
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<MessagesModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => MessagesModel.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
